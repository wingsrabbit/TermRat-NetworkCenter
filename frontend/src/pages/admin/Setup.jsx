/* ============================================================
   TermRat — 初次安装向导 (/termadmin，库内无用户时显示)
...
export function Setup() {
  ...
  const [title, setTitle] = useState("TermRat 网络状态中心");
    ...
    <div style={{
      ...
      <div className="fade-up" style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 22 }}>
          ...
          <p className="muted" style={{ fontSize: 13, marginTop: 4 }}>创建管理员账号，开始使用 TermRat 网络状态中心</p>
        </div>
