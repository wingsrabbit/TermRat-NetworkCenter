...
function Login() {
  ...
  useEffect(() => { if (auth) navigate("/termadmin/dashboard"); }, []);
      ...
      <div className="row between" style={{ height: 56, padding: collapsed ? "0" : "0 16px", justifyContent: collapsed ? "center" : "space-between", borderBottom: "1px solid var(--border)" }}>
        {collapsed
          ...
          : <div className="row gap-8" style={{ overflow: "hidden", whiteSpace: "nowrap" }}>
              ...
              <span style={{ fontWeight: 660, fontSize: 14.5 }}>TermRat <span className="faint" style={{ fontWeight: 500, fontSize: 12 }}>v1.0</span></span>
            </div>}
      </div>
                ...
                <div className="menu" style={{ right: 0, top: 42, minWidth: 200 }}>
                  ...
                  <div style={{ padding: "4px 10px 6px" }}>
                    ...
                    <div className="seg" style={{ width: "100%" }}>
                      ...
                      <button className={auth.role === "readonly" ? "active" : ""} style={{ flex: 1 }} onClick={() => { setRole("readonly"); navigate("/termadmin/dashboard"); }}>只读</button>
                    </div>
                  </div>
                  <div className="divider" style={{ margin: "4px 0" }} />
